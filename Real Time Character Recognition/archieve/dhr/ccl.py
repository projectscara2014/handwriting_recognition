...
import copy
import ccl_utils
import decision_maker_run_mode
...
# @time_this_function
def main(bnw_im,output_type = "Number_array"):
	global COUNT
	global var_array
	var_array = []
	COUNT = 1
	...
	if(output_type == "color"):
		...
		[coordinates_space,dimensions_space] = ccl_utils.main(ccl_image,[dict_space,count_space])
		decision_maker_run_mode.main(dict_space,count_space,coordinates_space,dimensions_space)

	return [ccl_image,dict_space,count_space]
